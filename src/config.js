export default {
  ...
  team: {
    '2017_2': [
      ...
      {name: 'Cody Ley-Han', title: 'Sr. Developer', image: '/assets/profiles/cody_ley_han.jpg', bio: 'Originally from a farm, now sunnny LA. Ukulele playing kid willing to work for Chick-fil-A, hoping to make it big some day.'},
      {name: 'Adit Deshpande', title: 'Sr. Developer', image: '/assets/profiles/adit_deshpande.jpg', bio: 'A bay area native who codes and watches sports. Literally 96% of my life. Interested in machine learning and artificial intelligence and love writing about them on my personal blog. Next goal: Build a machine learning model to auto-create this bio for me.'},
      {name: 'Karen Li ', title: 'Sr. Developer', image: '/assets/profiles/karen_li.jpg', bio: 'Currently either eating, Yelping, or thinking about food. Canadian born and raised. Likes eating potatoes but not being one; avid runner and snowboarder. Enjoys skateboarding and has only wiped out on Bruinwalk twice.'},
      ...
      {name: 'Brandon Liu', title: 'Sr. Developer', image: '/assets/profiles/brandon_liu.jpg', bio: 'I enjoy life for a living. Throw in some California burritos and cabeza tacos, sprinkle in some rock climbing and the great outdoors, and that\'s all anyone could ask for.'},
      {name: 'Aditya Raju', title: 'Sr. Developer', image: '/assets/profiles/aditya_raju.jpg', bio: 'I like sports. I like the Phoenix Suns. I like turtles and puppies. And I like to learn new things. One of my main goals in life is to become successful, and give back by becoming a high school teacher.'},
      ...
      {name: 'Rishub Kumar', title: 'Product Manager', image: '/assets/profiles/rishub_kumar.jpg', bio: 'Bay Area Native. Shorts and flip flops, can never leave the west coast. Goes to class to code and all I use is python, will scrape anything. Loves to eat, watch sports, and chill.  Go Warriors!'},
      ...
      {name: 'Shalini Dangi', title: 'Sr. Developer', image: '/assets/profiles/shalini_dangi.jpg', bio: 'Born and raised in beautiful Southern California. National Park enthusiast. Die-hard Lakers fan. Avid R&B concert goer.'},
      {name: 'Helen Lee', title: 'Jr. Developer', image: '/assets/profiles/helen_lee.jpg', bio: 'Raised in SoCal and blessed to spend another 4 years here. Handing out trash bags, encoding room keys, coding: it\'s a constant journey of self-discovery.'},
      {name: 'Ankur Papneja', title: 'Sr. Developer', image: '/assets/profiles/ankur_papneja.jpg', bio: 'Pushes code during the day, lifts weights by night. Grew up in LA watching the Lakers. Claims that caffeine has incredible abilities.'},
      {name: 'Jeffrey Chan', title: 'Sr. Developer', image: '/assets/profiles/jeffrey_chan.jpg', bio: 'LA native patiently waiting for my wings to grow out. The only forces on this planet that can hold me down are gravity, Chipotle, and KBBQ.'},
      {name: 'Ashwin Vivek', title: 'Jr. Developer', image: '/assets/profiles/ashwin_vivek.jpg', bio: 'Has lived around the globe, but still manages to get lost with google maps. Likes tennis, software, and being vegetarian. Currently resides in Hong Kong, where he hopes to find food without meat in it.'},
      {name: 'Jasmine Kim', title: 'Product Manager', image: '/assets/profiles/jasmine_kim.jpg', bio: 'Change is the only constant in her life. Geeks out on Myers-Briggs, classical mythologies, and film scores. A believer in human potential and matcha.'},
      {name: 'Karen Fann', title: 'Jr. Developer', image: '/assets/profiles/karen_fann.jpg', bio: 'A short stack of pancakes but will break your ankles in basketball. Jasmine tea and majestic views keep me happy. Knows every Taylor Swift song by heart.'},
      {name: 'Tanzeela Khan', title: 'Jr. Developer', image: '/assets/profiles/tanzeela_khan.jpg', bio: 'Bay area girl who likes her chocolate 80-90% dark and her musicals 100% captivating. When she\'s not hacking, she\'s hiking.'},
      {name: 'Suyash Saxena', title: 'Jr. Dev & Design', image: '/assets/profiles/suyash_saxena.jpg', bio: 'Last seen in yellow Crocs, rubber-banded spectacles, notoriously stopping MetroLink Trains en route hackathons and adventures across California.'},
      {name: 'Elton Leong', title: 'Sr. Developer', image: '/assets/profiles/elton_leong.jpg', bio: 'Drinks too much boba and owns too many mechanical keyboards. Currently using a WhiteFox with 65g Zealios.'},
      ...
      {name: 'Nikhil Kansal', title: 'Sr. Developer', image: '/assets/profiles/nikhil_kansal.jpg', bio: 'Not talented enough to be a world-class DJ, but definitely enough to be a software engineer. Loves OneRepublic, Coldplay, St. Lucia, Kygo, CHVRCHES, and the like. Has watched The Office and Parks and Rec three times. Hufflepuff. Whovian. ISFP-A.'},
      {name: 'Jorge Fuentes', title: 'Sr. Developer', image: '/assets/profiles/jorge_fuentes.jpg', bio: 'A lifelong adventurer with a delectable taste for random trivia and quesadillas. Enjoys the struggle of anagonizing over code while listening to melancholy music in the dark. Has yet to give up on his childhood dream of being a ninja.'},
      ...
      {name: 'Charlotte McGinn', title: 'Sr. Developer', image: '/assets/profiles/charlotte_mcginn.jpg', bio: 'Enjoys solving problems with code as much as wielding Copic markers to create crafts. Certain that she will change the world, uncertain of how to go about it. Extroverted introvert, part time Pokémon trainer, and wannabe hipster. Sassy, yet sophisticated.'},
      {name: 'Rohan Kapoor', title: 'Sr. Dev & Design', image: '/assets/profiles/rohan_kapoor.jpg', bio: 'Product Designer from LA. Majoring in Computer Science at UCLA. Loves to skateboard, read books, watch movies, and obviously design.'},
      {name: 'Camille Zhang', title: 'Jr. Developer', image: '/assets/profiles/camille_zhang.jpg', bio: '3rd year CS major. Music lover, traveler, spent 4 years of schooling and bar singing in NEW ZEALAND!! Looking into learning more about web development through DevX!'},
      {name: 'Shivam Thapar', title: 'Sr. Developer', image: '/assets/profiles/shivam_thapar.jpg', bio: 'Code enthusiast who loves his french press a little too much'},
      {name: 'Jesse Cai', title: 'Sr. Developer', image: '/assets/profiles/jesse_cai.jpg', bio: 'I\'m a second year CS major.'},
      {name: 'Andy Yu', title: 'Sr. Developer', image: '/assets/profiles/andy_yu.jpg', bio: 'Bookworm, puzzle aficionado,  self-proclaimed full stack developer. Likes Python and four space indents with the same passion as his dislike of RoR. Climber of rocks and sometimes trees. Has a pet houseplant named Auri.'},
      ...
      {name: 'Lawrence Chen', title: 'Jr. Developer', image: '/assets/profiles/lawrence_chen.jpg', bio: 'Former wannabe baller, actor, and dancer... Current wannabe coder... Future wannabe rapper... It\'s a process. But if anyone ever wants to make an app that helps choreograph a basketball themed Lin-Manuel musical? I\'m your guy.'},
      ...
      {name: 'Austin Lee', title: 'Sr. Developer', image: '/assets/profiles/austin_lee.jpg', bio: 'I love building cool and useful stuff. Challenges excite me and pursuing opportunities to learn will always be one of my top priorities. You will find me jamming on the guitar, performing at hospitals with my A Cappella group, and hacking with friends.'},
      {name: 'William Shao', title: 'Sr. Developer', image: '/assets/profiles/william_shao.jpg', bio: 'Born and raised in the Bay. True Kanye West fan. When not coding, can be found on the basketball court or playing guitar. Loves learning beautiful math and being fed Chinese food, pho, and Cheez-its.'},
      {name: 'Katie Luangkote', title: 'Sr. Developer', image: '/assets/profiles/katie_luangkote.jpg', bio: 'I\'m North Orange County born and raised. Lover of potatoes in any way, shape, or form. Seinfeld addict and enthusiast.'},
      ...
      {name: 'Ram Goli', title: 'Jr. Developer', image: '/assets/profiles/ram_goli.jpg', bio: 'An idealist and sentimentalist. Enjoys dreaming, getting all philosophical up in dis, and talking to new peeps. If needed, can be found outdoors throwing frisbees at other people, or in the kitchen eating LOTS of chocolate. Will also write code if you ask nicely'},
      {name: 'Alex Fong', title: 'Sr. Developer', image: '/assets/profiles/alex_fong.jpg', bio: 'Born in the hella cool capital city of California. He can now be found stumbling his way around the web, waiting for the next fix of ice cream or boba, or looking for the cheapest way to get halfway around the world.'},
      {name: 'Yvonne Chen', title: 'Sr. Dev & Design', image: '/assets/profiles/yvonne_chen.jpg', bio: 'I like drinking tea.'},
      {name: 'Nurym Kudaibergen', title: 'Sr. Developer', image: '/assets/profiles/nurym_kudaibergen.jpg', bio: 'Lover of #ff9500, Sigur Rós, fine photographs, tetris and good typography. Wishes to own a fox as a pet.'},
    ]
  }
}
